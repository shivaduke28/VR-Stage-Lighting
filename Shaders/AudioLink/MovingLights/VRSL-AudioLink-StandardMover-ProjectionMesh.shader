Shader "VRSL/AudioLink/Standard Mover/Projection"
{
	...
	Properties
	{
		...
		_ProjectionUVMod2 ("Projection UV Scale Modifier ", Range(0,1)) = 0
		[NoScaleOffset] _ProjectionTex3 ("Projection Texture GOBO 3", 2D) = "white"{}
		_ProjectionUVMod3 ("Projection UV Scale Modifier ", Range(0,1)) = 0
		[NoScaleOffset] _ProjectionTex4 ("Projection Texture GOBO 4", 2D) = "white"{}
		_ProjectionUVMod4 ("Projection UV Scale Modifier ", Range(0,1)) = 0
		[NoScaleOffset] _ProjectionTex5 ("Projection Texture GOBO 5", 2D) = "white"{}
		_ProjectionUVMod5 ("Projection UV Scale Modifier ", Range(0,1)) = 0
		[NoScaleOffset] _ProjectionTex6 ("Projection Texture GOBO 6", 2D) = "white"{}
		_ProjectionUVMod6 ("Projection UV Scale Modifier ", Range(0,1)) = 0	
		//[Space(8)]	
